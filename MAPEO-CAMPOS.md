...
| Colonia | `colonia` | No | Capa geográfica | Nombre como viene en la capa: mayúsculas y tipo entre paréntesis, `SAN MIGUEL (BARR)` (D62). Nulo donde la capa no tiene colonia (suelo de conservación y 31 km² urbanos), y la pantalla dice «Sin colonia en la capa» (D152). **Capa de prueba (IECM 2022)**: se sustituye antes de liberar la etapa. [pendiente] Confirmar con el SIA si la unidad oficial es colonia o unidad territorial |
