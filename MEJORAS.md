...
Al pie de cualquier pantalla: **«Versión 0.6.25 (Bloque 44)»**.
...
|---|---|---|---|---|---|
| M24 | iPhone · siguientes partes | Revisar Mis registros, detalle, Reportes, Catálogos y Usuarios | Alta | Pendiente | Capturas sugeridas: Mis registros con varios árboles; detalle de un registro (arriba y abajo); menú de la tuerca abierto; Reportes con el parte del día; Catálogos y Usuarios, lista y ventana de alta |
| M02 | Lista de diseño #1 | Navegación inferior en teléfono | Alta | Propuesto | Bloque aparte: cambia la estructura |
| M05 | Lista de diseño #4 | Registros como tarjetas con miniatura | Alta | Propuesto | Conviene decidirlo con las capturas de Mis registros |
