...
with sync_playwright() as p:
    ...
    reales = pg.evaluate("""async () => {
      ...
      return {
        ...
        jornadas: ['id','es_ficticio','nombre','ubicacion','lat','lng','gps_precision_m','alcaldia_cve','alcaldia','colonia_cve','colonia','fecha','comentarios','cabo_id','estatus','fecha_inicio','fecha_cierre','encargado_id','creado_por_id','fecha_creacion',
